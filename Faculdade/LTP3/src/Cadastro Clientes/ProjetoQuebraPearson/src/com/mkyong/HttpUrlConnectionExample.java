...
public class HttpUrlConnectionExample {
  ...
  public static void main(String[] args) throws Exception {
	...
	String postParams = http.getFormParams(page, "224731971", "220718");
  ...
  private void sendPost(String url, String postParams) throws Exception {
	...
	conn.setRequestProperty("Host", "fumec.bv3.digitalpages.com.br");
	...
	conn.setRequestProperty("Referer", "http://fumec.bv3.digitalpages.com.br/users/publications");
